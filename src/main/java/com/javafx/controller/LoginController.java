...
public class LoginController extends FXMLController implements Initializable {
    ...
    private ObservableList<Account> clients = FXCollections.observableArrayList();
    ...
    @FXML
    private TableView<Account> tblVwClients;
...
//
//        Account selectedClient = tblVwClients.getSelectionModel().getSelectedItem();
...
//            try {
//
//                List<Account> clientsRefreshed = clientDataService.remove(selectedClient);
//                clients.clear();
